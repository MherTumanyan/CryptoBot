...
var _1 = require(".");
var GraphqlClientProvider = /** @class */ (function (_super) {
    __extends(GraphqlClientProvider, _super);
    function GraphqlClientProvider(nsp, envProvider) {
        var _this = _super.call(this, 'GraphqlClientProvider') || this;
        _this.nsp = nsp;
        _this.envProvider = envProvider;
        return _this;
    }
    GraphqlClientProvider.prototype.initializer = function () {
    ...
    GraphqlClientProvider = __decorate([
        di_1.Injectable({
...
//# sourceMappingURL=graphql.client.provider.js.map