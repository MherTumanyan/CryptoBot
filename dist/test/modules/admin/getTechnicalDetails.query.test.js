...
describe.each(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  input \n  ", "\n  ", "\n"], ["\n  input \n  ", "\n  ", "\n"])), input1, input2)('When the :input is $input', function (_a) {
    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        var query, expected, result, isApolloError_1, expectedError_1, result_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, helper_1.data(query, { TechnicalModel: TechnicalModel })];
                case 2:
                    result = _a.sent();
                ...
                case 3:
                    ...
                    return [2 /*return*/, isApolloError_1 ? expect(result_1.errors[0]).toBeInstanceOf(graphql_1.GraphQLError) : expect(result_1.data.getTechnicalDetails.code).toEqual(input.expected.error)];
                case 4:
...
//# sourceMappingURL=getTechnicalDetails.query.test.js.map