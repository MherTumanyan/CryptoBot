...
describe.each(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  input \n  ", "\n  ", "\n  ", "\n  "], ["\n  input \n  ", "\n  ", "\n  ", "\n  "])), input1, input2, input3)('When the :input is $input', function (_a) {
    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        var query, expected, outgoingTransaction, isApolloError_1, expectedError_1, result_1, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = input.query, expected = input.expected, outgoingTransaction = input.outgoingTransaction;
                    if (!outgoingTransaction) return [3 /*break*/, 3];
                    return [4 /*yield*/, OutgoingTransactionModel.create(utils_1.OutgoingTransactionData3)];
                case 1:
                    _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user8 })];
                case 4:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 5: return [4 /*yield*/, helper_1.data(query, { OutgoingTransactionModel: OutgoingTransactionModel, UserModel: UserModel, injector: helper_1.injector })];
                case 6:
                    result = _a.sent();
...
//# sourceMappingURL=checkEasyTransferStatus.mutation.test.js.map