        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, IncomingTransactionModel.create({ userId: '5656c6d2-b3a3-46bf-a3f9-5aba260bb160', status: types_1.TransactionStatus.Pending, method: types_1.IncomingTransactionMethod.Payment, address: 'aer4s5s-5as-5daaa', amount: '1' })];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    if (trasactionStatusCompleted) {
                        helper_1.injector.provide({
                            ...
                            useValue: {
                                // @ts-ignore
                                getTransaction: function () { return Promise.resolve({ status: types_1.TransactionStatus.Completed, network: { transaction_url: 'url' } }); },
                            }
                        });
                    }
                ...
                case 4: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6, UserModel: UserModel, IncomingTransactionModel: IncomingTransactionModel })];
                case 5:
                    result = _a.sent();
...
//# sourceMappingURL=checkReceiveCoinTransactions.mutation.test.js.map