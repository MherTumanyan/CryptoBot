        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { user: utils_1.user6 })];
                case 1:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 2: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6, ReceivingAddressModel: ReceivingAddressModel })];
                case 3:
                    result = _a.sent();
...
//# sourceMappingURL=getNewReceivingAddress.quert.test.js.map