...
var input4 = {
    ...
    query: graphql_tag_1.default(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  mutation { \n    createWithdrawOrder( currency: ", ", amountInCurrency: -15, coinType: ", ", coinAddress: \"4d55f68-f55d8d66d-df55fd5-f66f44\" ) {\n        success, \n        code, \n        error,\n      }\n    }\n  "], ["\n  mutation { \n    createWithdrawOrder( currency: ", ", amountInCurrency: -15, coinType: ", ", coinAddress: \"4d55f68-f55d8d66d-df55fd5-f66f44\" ) {\n        success, \n        code, \n        error,\n      }\n    }\n  "])), types_1.CurrencyType.Usd, types_1.CoinType.Dash),
    isValidTransferAmount: { error: '', code: 200, success: true },
    expected: {
        data: {
            createWithdrawOrder: {
...
describe.each(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  input\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  "], ["\n  input\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  "])), input1, input2, input3, input4, input5)('When the :input is $input', function (_a) {
    var input = _a.input;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user7, OutgoingTransactionModel: OutgoingTransactionModel, HistoryMetaModel: HistoryMetaModel })];
                case 1:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 2: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user7, OutgoingTransactionModel: OutgoingTransactionModel, HistoryMetaModel: HistoryMetaModel, ReceivingAddressModel: ReceivingAddressModel })];
                case 3:
                    result = _a.sent();
...
//# sourceMappingURL=createWithdrawOrder.mutation.test.js.map