...
var input1 = {
    ...
    query: graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  mutation{ \n    createEasyTransferOrder( currency: ", ", amountInCurrency: 15, coinType: ", ", coinType: ", ", , receiverAccountId: \"35684569542\") {\n        error, \n        code, \n        success \n      }\n    }\n  "], ["\n  mutation{ \n    createEasyTransferOrder( currency: ", ", amountInCurrency: 15, coinType: ", ", coinType: ", ", , receiverAccountId: \"35684569542\") {\n        error, \n        code, \n        success \n      }\n    }\n  "])), types_1.CurrencyType.Usd, types_1.CoinType.Dash, types_1.CoinType.Dash),
...
var input2 = {
    ...
    query: graphql_tag_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    mutation{ \n      createEasyTransferOrder( currency: ", ", amountInCurrency: 15, coinType: ", ", coinType: ", ", , receiverAccountId: \"6542793158s5\") {\n          error, \n          code, \n          success \n        }\n      }\n    "], ["\n    mutation{ \n      createEasyTransferOrder( currency: ", ", amountInCurrency: 15, coinType: ", ", coinType: ", ", , receiverAccountId: \"6542793158s5\") {\n          error, \n          code, \n          success \n        }\n      }\n    "])), types_1.CurrencyType.Usd, types_1.CoinType.Dash, types_1.CoinType.Dash),
    isValidTransferAmount: { error: '', code: 200, success: true },
    expected: {
        data: {
            createEasyTransferOrder: {
...
describe.each(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  input \n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  input \n  ", "\n  ", "\n  ", "\n  ", "\n"])), input1, input2, input3, input4)('When the :input is $input', function (_a) {
    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserModel.create(utils_1.user10)];
                case 1:
                    _a.sent();
                    ...
                    if (!input.expected.error) return [3 /*break*/, 3];
                    ...
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user10, UserModel: UserModel, OutgoingTransactionModel: OutgoingTransactionModel, HistoryMetaModel: HistoryMetaModel })];
                case 2:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 3: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user10, UserModel: UserModel, OutgoingTransactionModel: OutgoingTransactionModel, HistoryMetaModel: HistoryMetaModel })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=createEasyTransferOrder.mutation.test.js.map