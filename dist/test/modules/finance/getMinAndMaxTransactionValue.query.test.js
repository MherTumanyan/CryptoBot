...
var TechnicalModel = helper_1.getModels('Technical', 'technical');
var input1 = {
    title: 'test getMinAndMaxTransactionValue query',
    query: graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  { \n    getMinAndMaxTransactionValue(coinType: ", ", currency: ", ") {\n        minTransactionValue\n        maxTransactionValue\n      }\n    }\n  "], ["\n  { \n    getMinAndMaxTransactionValue(coinType: ", ", currency: ", ") {\n        minTransactionValue\n        maxTransactionValue\n      }\n    }\n  "])), core_1.CoinType.Btc, core_1.CurrencyType.Usd),
    expected: {
        data: {
...
var input3 = {
    ...
    expected: graphql_1.GraphQLError,
};
var input4 = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, TechnicalModel.create(utils_1.technicalData)];
                case 1:
                    _a.sent();
                    ...
                    // @ts-ignore
                    TechnicalModel = jest.fn().mockImplementation(function () {
                        if (isApolloError_1)
                            throw expectedError_1;
                        return expectedError_1;
                    });
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, TechnicalModel: TechnicalModel })];
                case 2:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 3: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, TechnicalModel: TechnicalModel })];
                case 4:
                    result = _a.sent();
                    if (result.errors) {
                        return [2 /*return*/, expect(result.errors[0]).toBeInstanceOf(expected)];
                    }
...
//# sourceMappingURL=getMinAndMaxTransactionValue.query.test.js.map