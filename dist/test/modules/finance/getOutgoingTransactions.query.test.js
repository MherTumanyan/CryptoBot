    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, helper_1.data(query, { OutgoingTransactionModel: OutgoingTransactionModel, user: utils_1.user8 })];
                case 3:
                    result = _a.sent();
...
//# sourceMappingURL=getOutgoingTransactions.query.test.js.map