        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // @ts-ignore
                    OutgoingTransactionModel = jest.fn().mockImplementation(function () {
                        if (isApolloError_1)
                ...
                case 2: return [4 /*yield*/, OutgoingTransactionModel.create(utils_1.OutgoingTransactionData3)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, helper_1.data(query, { OutgoingTransactionModel: OutgoingTransactionModel })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=cancelEasyTransfer.mutation.test.js.map