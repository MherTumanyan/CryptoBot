        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, UserModel.create(utils_1.user12)];
                case 1:
                    _a.sent();
                    ...
                    return [4 /*yield*/, helper_1.data(query, { UserModel: UserModel })];
                case 2:
                    result_1 = _a.sent();
                ...
                case 3: return [4 /*yield*/, helper_1.data(query, { UserModel: UserModel })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=validatePhoneNumber.query.test.js.map