...
var input1 = {
    ...
    query: graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  query{ \n    validateTransferAmount( amountInCoin: 15, totalAmountInCoin: 10, coin: ", " ) {\n       valid {\n         code\n       }\n      }\n    }\n  "], ["\n  query{ \n    validateTransferAmount( amountInCoin: 15, totalAmountInCoin: 10, coin: ", " ) {\n       valid {\n         code\n       }\n      }\n    }\n  "])), core_1.CoinType.Dash),
    expected: {
        data: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { user: utils_1.user1, injector: helper_1.injector })];
                case 1:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 2: return [4 /*yield*/, helper_1.data(query, { user: utils_1.user1, injector: helper_1.injector })];
                case 3:
                    result = _a.sent();
...
//# sourceMappingURL=validateTransferAmount.query.test.js.map