...
describe.each(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  input\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  input\n  ", "\n  ", "\n  ", "\n  ", "\n"])), input1, input2, input3, input4)('When the :input is $input', function (_a) {
    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        var query, expected, isValidTransfer, isApolloError_1, expectedError_1, result_1, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = input.query, expected = input.expected, isValidTransfer = input.isValidTransfer;
                    // @ts-ignore
                    modules.isValidTransferAmount = jest.fn().mockReturnValue({ error: '', code: 200, success: true });
                    if (isValidTransfer === null || isValidTransfer === void 0 ? void 0 : isValidTransfer.code) {
                        // @ts-ignore
                ...
                case 2:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6, UserModel: UserModel, OutgoingTransactionModel: OutgoingTransactionModel, IncomingTransactionModel: IncomingTransactionModel, HistoryMetaModel: HistoryMetaModel })];
                case 3:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 4: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6, UserModel: UserModel, OutgoingTransactionModel: OutgoingTransactionModel, IncomingTransactionModel: IncomingTransactionModel, HistoryMetaModel: HistoryMetaModel })];
                case 5:
                    result = _a.sent();
...
//# sourceMappingURL=acceptEasyTransferOrder.mutation.test.js.map