...
describe.each(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  input\n  ", "\n  ", "\n  ", "\n"], ["\n  input\n  ", "\n  ", "\n  ", "\n"])), input1, input2, input3)('When the :input is $input', function (_a) {
    ...
    it("" + input.title, function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, query, expected, responceCode, result_1, isApolloError_1, expectedError_1, result_2, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserModel.create(utils_1.userData1)];
                case 1:
                    user = _a.sent();
                    query = input.query, expected = input.expected, responceCode = input.responceCode;
                    finance_query_1.Query.validateName = jest.fn().mockImplementation(function () {
                        return { error: '', code: 200, success: true };
                    });
                    if (!responceCode) return [3 /*break*/, 3];
                    finance_query_1.Query.validateName = jest.fn().mockImplementation(function () {
                        return { error: '', code: 400, success: false };
                    });
                    return [4 /*yield*/, helper_1.data(query, { UserModel: UserModel, user: user })];
                case 2:
                    result_1 = _a.sent();
                    return [2 /*return*/, expect(result_1).toEqual(expected)];
                case 3:
                    if (!input.expected.error) return [3 /*break*/, 5];
                    isApolloError_1 = input.expected.error instanceof apollo_server_errors_1.ApolloError;
                    ...
                    return [4 /*yield*/, helper_1.data(query, { user: user })];
                case 4:
                    result_2 = _a.sent();
                    return [2 /*return*/, isApolloError_1 ? expect(result_2.errors[0]).toBeInstanceOf(graphql_1.GraphQLError) : expect(result_2.data.updateUser.code).toEqual(input.expected.error)];
                case 5: return [4 /*yield*/, helper_1.data(query, { UserModel: UserModel, user: user })];
                case 6:
                    result = _a.sent();
...
//# sourceMappingURL=updateUser.mutation.test.js.map