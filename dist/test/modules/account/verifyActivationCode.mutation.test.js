        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { UserModel: UserModel, user: utils_1.user5 })];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    result_1 = _a.sent();
                    return [2 /*return*/, isApolloError_1 ? expect(result_1.errors[0]).toBeInstanceOf(graphql_1.GraphQLError) : expect(result_1.data.verifyActivationCode.code).toEqual(input.expected.error)];
                case 3:
...
//# sourceMappingURL=verifyActivationCode.mutation.test.js.map