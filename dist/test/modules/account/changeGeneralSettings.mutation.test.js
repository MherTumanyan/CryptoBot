        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6 })];
                case 2:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 3: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, user: utils_1.user6, UserModel: UserModel })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=changeGeneralSettings.mutation.test.js.map