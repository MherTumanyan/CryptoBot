        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, UserModel.create(utils_1.user4)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    result_1 = _a.sent();
                    return [2 /*return*/, isApolloError_1 ? expect(result_1.errors[0]).toBeInstanceOf(graphql_1.GraphQLError) : expect(result_1.data.sendVerificationSms.code).toEqual(input.expected.error)];
                case 3: return [4 /*yield*/, helper_1.data(query, { user: utils_1.user4, UserModel: UserModel, injector: helper_1.injector })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=sendVerificationSms.mutation.test.js.map