        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, helper_1.data(query, { user: utils_1.user7 })];
                case 2:
                    result_1 = _a.sent();
                    // @ts-ignore
                ...
                case 3: return [4 /*yield*/, helper_1.data(query, { injector: helper_1.injector, UserModel: UserModel, user: utils_1.user7 })];
                case 4:
                    result = _a.sent();
...
//# sourceMappingURL=getAccount.query.test.js.map