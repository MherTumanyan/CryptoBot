...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "typedoc/dist/lib/converter/components", "typedoc/dist/lib/converter/converter", "typedoc/dist/lib/converter/plugins/CommentPlugin", "typedoc/dist/lib/models/reflections/abstract", "typedoc/dist/lib/models/reflections/declaration", "./getRawComment", "semver"], factory);
    }
    ...
    const useOldDeclarationReflectionConstructor = semver_1.satisfies(version, '< 0.14.0');
    /**
                ...
                for (let i = 0; i < nameParts.length - 1; ++i) {
                    ...
                    if (!child) {
                        if (useOldDeclarationReflectionConstructor) {
                            ...
                            child = new declaration_1.DeclarationReflection(nameParts[i], abstract_1.ReflectionKind.ExternalModule, parent);
                        }
                        child.parent = parent;
                        child.children = [];
     ...
     */
    function updateSymbolMapping(project, symbolId, mappedReflectionId) {
