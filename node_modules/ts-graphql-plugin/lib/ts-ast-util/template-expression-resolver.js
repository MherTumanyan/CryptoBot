    ...
    update(target, innerPositionRangeToChange, text = '') {
        ...
        const getInnerPosition = (pos) => {
            ...
            if (x.pos < innerPositionRangeToChange.start) {
                ...
                return Object.assign(Object.assign({}, x), { pos: innerPositionRangeToChange.start });
            }
            else {
                return Object.assign(Object.assign({}, x), { pos: x.pos - (innerPositionRangeToChange.end - innerPositionRangeToChange.start) + text.length });
            }
        };
    ...
    _getValueAsString(fileName, node, dependencies = [fileName]) {
        ...
        if (ts.isStringLiteral(node)) {
            ...
            while (true) {
                ...
                if (!src)
                    return { dependencies };
                const found = _1.findNode(src, def.textSpan.start);
