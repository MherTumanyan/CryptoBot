...
const analyzer_factory_1 = require("../analyzer/analyzer-factory");
...
class TransformServer {
    constructor({ projectPath }) {
        ...
        const { analyzer, scriptHost } = new analyzer_factory_1.AnalyzerFactory().createAnalyzerAndScriptHostFromProjectPath(projectPath);
    ...
    getTransformer({ target = 'object', removeFragmentDefinitons = true, documentTransformers = [], getEnabled = () => true, } = {}) {
        ...
        return transformer_1.getTransformer({
            getEnabled,
            tag,
            target,
...
//# sourceMappingURL=transform-server.js.map