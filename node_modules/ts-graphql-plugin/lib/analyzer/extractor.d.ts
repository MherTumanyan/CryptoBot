...
export declare type ExtractTemplateResolveErrorResult = {
    fileName: string;
...
export declare type ExtractGraphQLErrorResult = {
    fileName: string;
    templateNode: ts.NoSubstitutionTemplateLiteral | ts.TemplateExpression;
...
export declare type ExtractSucceededResult = {
    fileName: string;
    templateNode: ts.NoSubstitutionTemplateLiteral | ts.TemplateExpression;
...
export declare type ExtractResult = ExtractTemplateResolveErrorResult | ExtractGraphQLErrorResult | ExtractSucceededResult;
export declare class Extractor {
    ...
    getDominantDefiniton(result: ExtractSucceededResult): {
        type: "other" | "query" | "mutation" | "subscription" | "fragment" | "complex" | undefined;
